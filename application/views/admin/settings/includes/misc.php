...
<div class="horizontal-scrollable-tabs">
  ...
  <div class="tab-content mtop30">
    <div role="tabpanel" class="tab-pane active" id="misc">
      ...
      <hr />
      <?php echo render_input('settings[sales_cc_email]', 'Sales person email (Send lead updates)', get_option('sales_cc_email'), 'text'); ?>
    ...
    <div role="tabpanel" class="tab-pane" id="settings_tables">
      <div class="form-group">
        ...
        <div class="radio radio-primary radio-inline">
          <input type="radio" id="y_opt_1_save_last_order_for_tables" name="settings[save_last_order_for_tables]" value="1" <?php if (get_option('save_last_order_for_tables') == '1') {
                                                                                                                              echo ' checked';
                                                                                                                            } ?>>
        ...
        <div class="radio radio-primary radio-inline">
          <input type="radio" id="y_opt_2_save_last_order_for_tables" name="settings[save_last_order_for_tables]" value="0" <?php if (get_option('save_last_order_for_tables') == '0') {
                                                                                                                              echo ' checked';
                                                                                                                            } ?>>
